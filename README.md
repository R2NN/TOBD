...
📁 Enterprise-Log-Intelligence-Platform/
 ...
 ┣ 📂 grafana/dashboards/# 6 дашбордов визуализации
 ┣ 📂 api/               # REST API
...
|------------|------------|
| **Big Data технология** | ✅ Dask (параллельная обработка) |
| **Система хранения** | ✅ PostgreSQL (RAW → Staging → DWH) |
| **ETL-процесс (3 задачи)** | ✅ Extract, Transform, Load |
| **Визуализация** | ✅ Grafana (6 дашбордов) + Web Dashboard |
| **Docker Compose** | ✅ 6 сервисов |
| **Документация** | ✅ ARCHITECTURE.md, report.md |
...
**Проектная работа по дисциплине «Технология обработки больших данных», 2025**
